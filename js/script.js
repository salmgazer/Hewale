...
function loadTasks() {
		...
		if (objResult.result == 1) {
			...
			for (var i = 0; i < tasks.length; i++) {
				nurseContent += '<div class="col s12 m6"><div class="card"><div class="card-content black-text"><span class="card-title">'+tasks[i]["summary"]+'</span><p>Description: '+tasks[i]["description"]+'<br>Assigned To: <br> '+tasks[i]["nurse"]+'</p></div></div></div>';
			}
			document.getElementById("content-container").innerHTML = nurseContent;
		}
}
