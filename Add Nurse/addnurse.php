...
*@author Adjoa Kwakye
*@version 1.0
*this page contains all functions
*/include_once("adb.php");
	...
	*/
        ...
        /**
	*@method boolean search_nurse() Searches a Nurse by using nurse name
	...
	*/
        ...
        /**
	*@method boolean get_all() Gets all nurses in the database
	*@return return bool
	*/
        ...
        function get_all()
        {
            $str_query = "SELECT * from h_account";
            return $this->query($str_query);
        }
